  ...
  return (
    <div className="w-1/5 px-4 h-[100vh] bg-blue-800">
      <div className="h-[15vh]">
        ...
        <div className="text-lg text-center w-full text-gray-200">
          <h3 className="">
            {user != "" ? <div>Admin Username</div> : <div>No Name</div>}
          </h3>
          <h4> {user != "" ? <div>03/05/2023</div> : <div></div>}</h4>
        </div>
      </div>
      {user != "" ? (
        <div>
          <div className="">
            <Link
              ...
              className="flex justify-start py-2 px-4 bg-blue-500 text-white font-semibold text-lg gap-4 w-full my-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
